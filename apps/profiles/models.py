...
class Profile(TimeStampedUUIDModel):
    ...
    profile_photo = models.ImageField(verbose_name=_("Profile Image"), default="/profile_default.jpg")
    gender = models.CharField(verbose_name=_("Gender"), choices=Gender.choices, default=Gender.OTHER, max_length=20)
    country = CountryField(verbose_name=_("Country"), default="AZ", blank=False, null=True)
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Baku", blank=False,
                            null=False)
