...
class Property(TimeStampedUUIDModel):
    ...
    city = models.CharField(verbose_name=_("City"), max_length=180, default="Nairobi", blank=True)
    ...
    tags = models.DecimalField(
        verbose_name=_("Property Tags"),
    ...
    def final_property_price(self):
        ...
        tax_amount = round(tax_percentage * property_price)
...
class PropertyViews(TimeStampedUUIDModel):
    ...
    property = models.ForeignKey(Property, related_name='property_views', verbose_name=_("Property"),
                                 on_delete=models.CASCADE)

    def __str__(self):
        return f'Total views on - {self.property.title} is - {self.property.views} view'
